...
public class ClientRegDto {
	...
	public String toString() {
		return "ClientRegDto [cust_name=" + cust_name + ", cust_phone1="
				+ cust_phone1 + ", cust_phone2=" + cust_phone2
				+ ", cust_phone3=" + cust_phone3 + ", cust_phone=" + cust_phone
				+ ", cust_birth=" + cust_birth + ", model_code=" + model_code
				+ ", price_name=" + price_name + ", cont_term=" + cont_term
				+ ", open_date=" + open_date + ", memo=" + memo + ", brc_id="
				+ brc_id + "]";
	}
