...
public class AdmModelPageDto {
	...
	private int pageSize = 5; // 페이징 갯수 (10페이지까지 갈 수 있게 표시하겠다는 내용)
	...
	public AdmModelPageDto() {
		// TODO Auto-generated constructor stub
	}
	
	public AdmModelPageDto(long pg, long totalCount) {
	...
	private String getPageHtml() {
		...
		String UrlName = "admModelList.do";
