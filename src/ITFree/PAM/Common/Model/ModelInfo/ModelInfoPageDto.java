...
public class ModelInfoPageDto {
	...
	public ModelInfoPageDto() {
		// TODO Auto-generated constructor stub
	}
	
	public ModelInfoPageDto(long pg, long totalCount) {
	...
	private String getPageHtml() {
		...
		String search = ""; //get방식으로 검색값을 넘겨주기 위해 분리한 변수
		String UrlName = "modelList.do";
	...
	public String toString() {
		return "ModelInfoPageDto [pg=" + pg + ", totalCount=" + totalCount
