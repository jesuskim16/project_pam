...
public class SalesRankPageDto {
	...
	private long RankTotalCount; // 총 게시물의 갯수
	...
	public SalesRankPageDto() {
		// TODO Auto-generated constructor stub
	}
	
	public SalesRankPageDto(long pg, long RankTotalCount , String brc_name, String s_sdate, String s_edate, String SalesRankSelectBox) {
		...
		pageCount = RankTotalCount / pageSize + (RankTotalCount % pageSize > 0 ? 1 : 0); // 총 페이징갯수 계산 알고리즘
	...
	private String getPageHtml() {
		...
		for(long p = startPage; p <= endPage; p++){
			...
			if(p != pg){
				pageHtml.append("<font class='style2'><a href='"+UrlName+"?pg=" + p + "&s_sdate="+s_sdate+"&"+"s_edate="+s_edate+"&"+
	...
	public long getRankTotalCount() {
		return RankTotalCount;
	}

	public void setRankTotalCount(long rankTotalCount) {
		RankTotalCount = rankTotalCount;
	}
	...
	public String toString() {
		return "SalesPageDto [brc_name=" + brc_name + ", s_sdate=" + s_sdate
				...
				+ ", RankTotalCount=" + RankTotalCount + ", pageCount=" + pageCount
