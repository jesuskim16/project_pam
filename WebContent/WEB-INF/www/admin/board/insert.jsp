...
<!-- 에디터/                                                          <textarea name="content" id="content" rows="10" cols="100" style="width:280px; height:280px; display:none;"></textarea> -->
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="editor/img/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="editor/img/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="editor/img/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder" src="editor/img/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
					<div class="tx-side-bi" id="tx_side_bi">
		<div style="text-align: right;">
			<img hspace="4" height="14" width="78" align="absmiddle" src="editor/img/icon/editor/editor_bi.png" />
		</div>
	</div>
				<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="editor/img/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
