...
<body leftmargin="0" topmargin="0" onload="document.members_login_form.userid.focus();">
<script>
function login_members(){	
	var frm = document.members_login_form;	
// 	if(frm.userid.value == ""){
// 			alert("아이디를 입력하세요");
// 			frm.userid.focus();
// 			return false;
...
<form action="loginAction.do" method="post" name="members_login_form">	
                      ...
                      <tr>
                        <td align="center" bgcolor="151515" style="height: 114px"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                              ...
                              <tr>
                                <td style="width: 241px"><table border="0" cellspacing="0" cellpadding="0" style="width: 101%">
                                  <tr>
                                    ...
                                    <td align="left" style="width: 175px"><input name="userid" type="text" id="textfield" style="width: 169px"></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
                            ...
                            <td width="10"></td>
                            <td><img src="img/btn_login.gif" width="104" height="54" onclick="login_members();" style="cursor:hand"></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
