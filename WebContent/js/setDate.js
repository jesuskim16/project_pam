...
function setNow(sdate,edate){
	document.result_form.s_sdate.value = sdate;
	document.result_form.s_edate.value = edate;
}
//페이지 로드시 시작일자를 오늘로 자동설정
var pageLoad = function(){
	var now = new Date();
	var s_today = changeDate(now);
	setNow(s_today,s_today);
}
